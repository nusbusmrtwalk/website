...
<p class="image-caption close">
  Notice the spur heading out from Promenade towards Dhoby Ghaut — the track
  layout we have does not permit trains turning back at Promenade, so trains
  from all directions must travel through the station.
</p>
...
<p className="image-caption close">
...
<p class="image-caption close">
  Official reasoning from the LTA, from their “Frequently Asked Questions on the
  CCL wayfinding”
</p>
